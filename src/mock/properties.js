...
const generateMockData = () => {
    const czechStreets = [
        { street: 'Václavské náměstí', number: '28', city: 'Praha 1', zip: '110 00', area: 'Nové Město' },
        { street: 'Pařížská', number: '15', city: 'Praha 1', zip: '110 00', area: 'Josefov' },
        { street: 'Vinohradská', number: '184', city: 'Praha 3', zip: '130 00', area: 'Vinohrady' },
        { street: 'Jugoslávská', number: '29', city: 'Praha 2', zip: '120 00', area: 'Vinohrady' },
        { street: 'Londýnská', number: '55', city: 'Praha 2', zip: '120 00', area: 'Vinohrady' },
        { street: 'Legerova', number: '12', city: 'Praha 2', zip: '120 00', area: 'Nové Město' },
        { street: 'Anglická', number: '23', city: 'Praha 2', zip: '120 00', area: 'Vinohrady' },
        { street: 'Masarykova', number: '56', city: 'Brno', zip: '602 00', area: 'Brno-střed' },
        { street: 'Veveří', number: '331', city: 'Brno', zip: '602 00', area: 'Veveří' },
        { street: 'Kounicova', number: '67a', city: 'Brno', zip: '602 00', area: 'Ponava' },
        { street: 'Česká', number: '149', city: 'Brno', zip: '602 00', area: 'Brno-střed' },
        { street: 'Nádražní', number: '124', city: 'Ostrava', zip: '702 00', area: 'Moravská Ostrava' },
        { street: '28. října', number: '88', city: 'Ostrava', zip: '702 00', area: 'Moravská Ostrava' },
        { street: 'Sokolská třída', number: '33', city: 'Ostrava', zip: '702 00', area: 'Moravská Ostrava' },
        { street: 'Hlavní třída', number: '142', city: 'Plzeň', zip: '301 00', area: 'Plzeň 1' },
        { street: 'Americká', number: '57', city: 'Plzeň', zip: '301 00', area: 'Plzeň 1' },
        { street: 'Palackého náměstí', number: '7', city: 'Olomouc', zip: '779 00', area: 'Olomouc-střed' },
        { street: 'Denisova', number: '31', city: 'Olomouc', zip: '779 00', area: 'Olomouc-střed' },
        { street: 'Hviezdoslavova', number: '15', city: 'Karlovy Vary', zip: '360 01', area: 'Karlovy Vary' },
        { street: 'Dr. Davida Bechera', number: '23', city: 'Karlovy Vary', zip: '360 01', area: 'Karlovy Vary' }
    ];
